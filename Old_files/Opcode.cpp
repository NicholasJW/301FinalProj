...
// Initializes all the fields for every instruction in Opcode enum
{
  ...
  myArray[J].name = "j";  myArray[J].numOps = 1;   myArray[J].rdPos = -1;  myArray[J].rsPos = -1;  myArray[J].rtPos = -1;   myArray[J].immPos = -1;  myArray[J].instType = JTYPE; myArray[J].op_field = "000010"; myArray[J].funct_field = "";
  //Your code here
